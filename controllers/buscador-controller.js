  ...
  clientServices.listaProductos().then(data => {
    data.forEach(({nombre, precio, imagen, id, categoria, descripcion}) => {
      ...
      if(validar || validarCategoria){
        const mostrarResultadoBuscado = mostrarProducto(nombre, precio, imagen, id, categoria, descripcion);
    ...
    if (evento.key === 'Enter') {
      ...
      clientServices.listaProductos().then(data => {
        data.forEach(({nombre, precio, imagen, id, categoria, descripcion}) => {
          ...
          if(validar){
            const mostrarProductoBuscado = mostrarProducto(nombre, precio, imagen, id, categoria, descripcion);
